import React$1, { useState, useEffect, useContext, useMemo, forwardRef, useRef, createRef, useReducer } from 'react';
...
var Port = function Port(_ref11) {
  ...
  return /*#__PURE__*/React$1.createElement(React$1.Fragment, null, /*#__PURE__*/React$1.createElement("div", {
    ...
    ref: port
  }), isDragging && !isInput ? /*#__PURE__*/React$1.createElement(Portal$1, {
...
var Node = /*#__PURE__*/forwardRef(function (_ref, nodeWrapper) {
  ...
  var _nodeTypes$type = nodeTypes[type],
      ...
      _nodeTypes$type$title = _nodeTypes$type.titleColor,
      titleColor = _nodeTypes$type$title === void 0 ? '#000' : _nodeTypes$type$title,
      _nodeTypes$type$tileB = _nodeTypes$type.tileBackground,
      tileBackground = _nodeTypes$type$tileB === void 0 ? '#494956' : _nodeTypes$type$tileB;
...
var FlumeConfig = /*#__PURE__*/function () {
  ...
  _createClass$1(FlumeConfig, [{
    ...
    value: function addNodeType(config) {
      ...
      if (typeof config.titleColor === 'string' && RegExp(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/g).test(config.titleColor)) node.titleColor = config.titleColor;
      if (typeof config.tileBackground === 'string' && RegExp(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/g).test(config.tileBackground)) node.tileBackground = config.tileBackground;
...
var NodeEditor = function NodeEditor(_ref, ref) {
  ...
  var _React$useReducer = React$1.useReducer(toastsReducer, []),
  ...
  var _React$useState5 = React$1.useState(true),
      _React$useState6 = _slicedToArray(_React$useState5, 2),
  ...
  var _React$useReducer7 = React$1.useReducer(stageReducer, {
...
NodeEditor = /*#__PURE__*/React$1.forwardRef(NodeEditor);
