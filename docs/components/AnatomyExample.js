  ...
  return (
    <NodeEditor
      ...
      comments={{
        ...
        "1C0j5YInSC": {
          id: "1C0j5YInSC",
          text: "Nodes can have inputs and/or outputs, but neither are required.",
          x: -286.875,
          y: 148,
          width: 218,
          height: 40,
        ...
        y6ABH04B7X: {
          id: "y6ABH04B7X",
          text: 'Inputs and outputs are referred to as "ports".',
          x: 45.125,
          y: 110,
          width: 156,
          height: 42,
        ...
        aZEqpLNSby: {
          id: "aZEqpLNSby",
          text: "Ports are color-coded to make the rules of connections intuitive for users.",
          x: 46.125,
          y: 160,
          width: 205,
          height: 55,
      ...
      defaultNodes={[{ type: "homepage", x: 200, y: -150 }]}
      nodes={{
        GMbW1Z5cc7: {
          id: "GMbW1Z5cc7",
          x: 127,
          ...
          connections: {
            inputs: {
              title: [{ nodeId: "JnwVXMbVL3", portName: "string" }],
              showDashboard: [{ nodeId: "MhtLSu9Q7D", portName: "isAdmin" }],
            },
            outputs: {},
          },
          inputData: {
        ...
        JnwVXMbVL3: {
          ...
          connections: {
            inputs: {},
            outputs: { string: [{ nodeId: "GMbW1Z5cc7", portName: "title" }] },
          },
          inputData: { string: { string: "Welcome to Flume!" } },
        },
        MhtLSu9Q7D: {
          id: "MhtLSu9Q7D",
          x: -238.875,
          ...
          connections: {
            inputs: {},
            outputs: {
              isAdmin: [{ nodeId: "GMbW1Z5cc7", portName: "showDashboard" }],
            },
          },
          inputData: {},
        },
