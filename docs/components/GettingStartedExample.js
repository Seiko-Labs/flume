...
const initialNodes2 = {
  ROk0lkW8E0: {
    id: "ROk0lkW8E0",
    x: 196.64930555555557,
    y: -107.77777777777779,
    type: "homepage",
    width: 170,
    connections: {
      inputs: {
  ...
  return (
    <NodeEditor
      ...
      comments={{
        lQxzhUQGnr: {
          id: "lQxzhUQGnr",
          text: "Add the user's first name to the title",
          x: -102.08333333333334,
          y: -245.55555555555557,
          width: 173.62847222222223,
          height: 41.439208984375,
          color: "blue",
        },
        bLkYimKb6F: {
          id: "bLkYimKb6F",
          text: "If the user is NOT logged in, show the signup.",
          x: -104.296875,
          y: 31.111111111111114,
          width: 180.10240342881946,
          height: 43.444417317708336,
          color: "green",
        },
      }}
      defaultNodes={[
